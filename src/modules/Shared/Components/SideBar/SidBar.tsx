      ...
      <Sidebar collapsed={isCollapsed}>
        <div className="relative">
          <button
            ...
            className="absolute -right-1 top-1 z-50 flex h-16 w-10 items-center justify-center bg-[#ef9b28] text-white shadow-md transition-all duration-300 hover:bg-[#d8871e]"
            style={{
        ...
        <Menu className='bg-[#0E382F] text-[#FFFFFF] pt-20' menuItemStyles={{
          button: ({ active }) => ({
