  ...
  return (
    <>
      ...
      <div className="flex items-center justify-between p-4 shadow-[0_10px_15px_-3px_rgba(0,0,0,0.15)] bg-white ">
        ...
        <div className="flex items-center gap-5 text-gray-500 px-10">
          {/* الجرس */}
          ...
          <div className="flex items-center justify-between p-2 bg-white rounded-lg min-w-[320px] cursor-pointer hover:bg-gray-50 transition-colors relative">
            ...
            <div className="relative">
              <div
                className="text-[#000000]/[0.37] pl-4 cursor-pointer hover:text-black transition-colors"
