...
const [pageSize, setPageSize] = useState(10);
  ...
  const getProjectsData = async (page: number, size: number) => {
    try {
      ...
      setPaginationInfo({
        ...
        totalNumberOfRecords: response.totalNumberOfRecords || 0,
      });
    } catch (error) {
      toast.error("faild to feach data");
    }
  };

  useEffect(() => {
    getProjectsData(currentPage, pageSize);
    ...
    <>
        ...
        <ModalBody className="bg-white rounded-xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 relative">
            <div className="space-y-4">
              ...
              <p>
                <b>Status:</b> {getProjectStatus(selectedProject?.task)}
              </p>
      ...
      <div className="overflow-x-auto shadow-md mx-10 bg-white">
          ...
          <TableBody>
            {projects?.map((project) => (
              <TableRow
                ...
                <TableCell>{project.users?.length || 0}</TableCell>
                        ...
                        <div className="fixed right-20 bottom-30 mt-10 w-32 bg-[#3159517c] shadow-[0_10px_30px_rgba(0,0,0,0.2)] rounded-xl z-[9999] p-1.5">
                          <div className="flex flex-col gap-0.5">
                            <button
                              ...
                              className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-white hover:bg-green-50 transition-all group">
                            ...
                            <button
                              ...
                              className="flex items-center gap-2 px-2 py-1.5 text-white rounded-lg hover:bg-yellow-50 transition-all group">
                            ...
                            <button
                              ...
                              className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-white hover:bg-red-50  transition-all group">
       ...
       <Pagination
          ...
          totalRecords={paginationInfo.totalNumberOfRecords}
          pageSize={pageSize}
