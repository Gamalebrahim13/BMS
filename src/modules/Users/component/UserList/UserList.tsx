        ...
        <ModalBody className="bg-white rounded-xl p-8 relative">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 relative">
            ...
            <div className="space-y-5">
              <h3 className="text-[#315951] font-bold text-lg mb-4">Account Info</h3>
              <div className="flex items-center gap-3">
                <FaUser size={16} className="text-[#315951]" />
                <p className="text-sm">
                  <span className="font-semibold text-gray-700">Username: </span>
                  <span className="text-[#315951] font-bold">{selectedUser?.userName || "-"}</span>
                </p>
              </div>
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm">
                  ...
                  <span className="text-[#315951] font-bold break-all">{selectedUser?.email || "-"}</span>
                </p>
              </div>
              <div className="flex items-center gap-3">
                ...
                <p className="text-sm">
                  ...
                  <span className="text-[#315951] font-bold">{selectedUser?.phoneNumber || "-"}</span>
                </p>
              </div>
            </div>

            <div className="space-y-5">
              <h3 className="text-[#315951] font-bold text-lg mb-4">Status & Location</h3>
              <div className="flex items-center gap-3">
                <FaEarthAmericas size={16} className="text-[#315951]" />
                <p className="text-sm">
                  <span className="font-semibold text-gray-700">Country: </span>
                  <span className="text-[#315951] font-bold">{selectedUser?.country || "-"}</span>
                </p>
              </div>
              <div className="flex items-center gap-3">
      ...
      <Table className="border-collapse rounded-0">
          ...
          <TableRow>
            <TableHeadCell className="border-r border-black/20">
              <div className="flex items-center gap-2 cursor-pointer">
                User Name <MdOutlineUnfoldMore size={20} />
              </div>
            </TableHeadCell>
            <TableHeadCell className="border-r border-black/20">
              <div className="flex items-center gap-2 cursor-pointer text-md">
                Status <MdOutlineUnfoldMore size={20} />
              </div>
            </TableHeadCell>
            <TableHeadCell className="border-r border-black/20">
              <div className="flex items-center gap-2 cursor-pointer px-3 py-1">
                Phone Number <MdOutlineUnfoldMore size={20} />
              </div>
            </TableHeadCell>
            <TableHeadCell className="border-r border-black/20">
              <div className="flex items-center gap-2 cursor-pointer">
                Email <MdOutlineUnfoldMore size={20} />
              </div>
            </TableHeadCell>
            <TableHeadCell className="border-r border-black/20">
              <div className="flex items-center gap-2 cursor-pointer">
                Date Created <MdOutlineUnfoldMore size={20} />
              </div>
            </TableHeadCell>
        ...
        <TableBody className="divide-y-0">
          {usersList.data.map((user) => (
            <TableRow key={user.id} className="odd:bg-white even:bg-[#F5F5F5] border-none">
              ...
              <TableCell className="text-black border-none text-lg">
                <span className={`px-5 py-2 rounded-full text-sm font-semibold inline-block ${
                  user.isActivated ? "bg-[#009247] text-white border border-green-200" : "bg-[#922E25B2]/70 text-white border border-red-200"
                }`}>
                  {user.isActivated ? "Active" : "Not Active"}
                </span>
              </TableCell>
              <TableCell className="text-black border-none text-lg">{user.phoneNumber}</TableCell>
              <TableCell className="text-black border-none text-lg">{user.email}</TableCell>
              <TableCell className="text-black border-none text-lg">
              ...
              <TableCell className="relative border-none text-lg">
                <div className="flex justify-center">
                  ...
                  {openMenuId === user.id && (
                    <>
                      <div className="fixed inset-0 z-[60] bg-transparent" onClick={() => setOpenMenuId(null)}></div>
                      <div className="fixed right-20 bottom-30 mt-10 w-32 bg-[#3159517c] shadow-xl rounded-xl z-[9999] p-1.5">
                        <div className="flex flex-col gap-0.5">
                          ...
                          >
                            <HiOutlineEye size={14} className="text-green-600 bg-white p-0.5 rounded" />
                            <span className="text-xs font-semibold text-gray-700">View</span>
                          </button>
                          <button
                            className="flex items-center gap-2 px-2 py-1.5 rounded-lg hover:bg-white/10 transition-all group text-white w-full"
                            onClick={() => handleToggleActivation(user.id)}
                          >
                            <MdOutlinePowerSettingsNew size={14} className={user.isActivated ? "text-red-600" : "text-green-600"} />
