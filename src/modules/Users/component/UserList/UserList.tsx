      ...
      <TableBody className="divide-y-0">
        {usersList?.data.map((user) => (
          ...
          >
            ...
            <TableCell className="text-black border-none text-lg">
              {/* Added optional chaining here to prevent application crashes */}
          ...
          {user.isActivated ? (
            <>
              <div className="p-1 bg-red-50 rounded-md group-hover:bg-red-100 transition-colors">
                <MdOutlinePowerSettingsNew size={14} className="text-red-600" />
              </div>
              <span className="text-xs font-semibold text-red-200 group-hover:text-red-400">
                Block
              </span>
            </>
          ) : (
            <>
              <div className="p-1 bg-green-50 rounded-md group-hover:bg-green-100 transition-colors">
                <MdOutlinePowerSettingsNew size={14} className="text-green-600" />
              </div>
              <span className="text-xs font-semibold text-green-200 group-hover:text-green-400">
                Activate
              </span>
            </>
          )}
