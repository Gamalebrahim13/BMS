  ...
  <p className="text-white/60 text-xs mt-2 font-light">Click to change photo</p>
        ...
        <div className="flex flex-row gap-4 mb-4">
          <div className="flex-1">
            ...
            {errors.userName && (
              <span className="text-primary text-xs">{errors.userName.message}</span>
            )}
          </div>
          <div className="flex-1">
            <div className="flex flex-col mb-2">
        ...
        <div className="flex flex-row gap-4 mb-4">
          <div className="flex-1">
            <div className="flex flex-col mb-2">
              <label className="text-primary text-sm font-light mb-0.5">Country</label>
              <input
                {...register("country")}
                type="text"
          ...
          <div className="flex-1">
            <div className="flex flex-col mb-2">
              <label className="text-primary text-sm font-light mb-0.5">Phone Number</label>
              <input
        ...
        <div className="flex flex-row gap-4 mb-4">
          <div className="flex-1">
            <div className="flex flex-col mb-2">
              <label className="text-primary text-sm font-light mb-0.5">Password</label>
              <input
                {...register("password")}
                type="password"
                className="bg-transparent font-light outline-none text-white placeholder:text-white w-full"
          ...
          <div className="flex-1">
            <div className="flex flex-col mb-2">
              <label className="text-primary text-sm font-light mb-0.5">Confirm Password</label>
              <input
