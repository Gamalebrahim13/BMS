...
<div className={`grid grid-cols-1 gap-6 px-5 ${loginData?.userGroup === "Manager" ? "lg:grid-cols-2" : "grid-cols-1"}`}>
  ...
  <div className="p-6 rounded-3xl bg-white shadow-sm">
    ...
    <div className={`flex flex-col ${loginData?.userGroup === "Employee" ? "lg:flex-row lg:items-center lg:justify-between gap-8" : ""}`}>
      
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8 max-w-xl flex-1">
      ...
      <div className={loginData?.userGroup === "Employee" ? "flex-1 flex justify-center lg:justify-end" : ""}>
        <TaskDonutChart
